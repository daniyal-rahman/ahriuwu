#!/bin/bash
# E04: E01's state at update 1520, continued with click snapping and XP weight 0 (lr 3e-4 as
...
ARGS=(--envs 6 --opponent mirror --start-near-wave --rollout 256 --updates 20000
      --step-ticks 6 --episode-s 600 --lr 3e-4 --critic-lr 3e-4 --xp-weight 0 --entropy-coef 0.001
