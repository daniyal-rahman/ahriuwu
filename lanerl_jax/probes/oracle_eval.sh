...
./.venv-jax/bin/python -m lanerl_jax.train.server_train --envs 4 --opponent $1 --start-near-wave --step-ticks 6 --episode-s 600 --seed 0 --port-base $3 --server-dir /mnt/nfs/projects/lanerl-vendor/LoLServer/GameServerConsole/bin/ClickV3/net6.0 --eval-episodes 1 --scripted $2 ${4:+--team $4} --out $OUT
