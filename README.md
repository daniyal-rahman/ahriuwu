...
The goal is to win modern League 5v5 against D2-level opponents. Current work
isolates ten-minute Garen mirror lanes using a source-available server and a
JAX training simulator. Navigation, screen-click actions, and the RL/server
loop are being hardened before further experiments.

- [Project direction, file map, and cleanup plan](docs/PROJECT.md)
- [Current technical evidence and unresolved issues](docs/JAX_FIDELITY_LEDGER.md)
- [Experiment method](docs/EXPERIMENT_METHOD.md)
- [Documentation and client-free replay commands](docs/README.md)
- [Agent working instructions](AGENTS.md)

## Historical Dreamer pipeline — preserved August 2026 snapshot

The remainder of this README describes the earlier world-model/BC work.
Its status and roadmap are historical, not the current project plan.
...
![GT vs dream at h=8](docs/archive/assets/dream_vs_gt_h8.png)
...
![Probe R² chart](docs/archive/assets/probe_r2.png)
...
![GT vs reconstruction montage](docs/archive/assets/hp_recon_montage.png)
...
![Reward head AUC](docs/archive/assets/reward_head_auc.png)
...
![BC loss curves](docs/archive/assets/bc_loss_curves.png)
...
![BC eval accuracy](docs/archive/assets/bc_eval_binacc.png)
...
- [`docs`](docs): progress notes, audits, analyses; README figures in [`docs/archive/assets`](docs/archive/assets)
