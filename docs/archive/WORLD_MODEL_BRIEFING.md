...
- **Reference:** Hafner\*, Yan\*, Lillicrap (2025), *"Training Agents Inside of Scalable World Models"* (Dreamer 4), arXiv **2509.24527v1**. PDF is in the repo (`Dreamerv4_paper.pdf`, 32pp). An exhaustive line-by-line paper-vs-code comparison already exists at `docs/archive/DYNAMICS_VS_PAPER.md` (632 lines) — this briefing summarizes and updates it.
...
Condensed from `docs/archive/DYNAMICS_VS_PAPER.md` (which cites the paper verbatim + our `file:line`). "Fixed since" = the 2026-07-04 audit doc flagged it and it was subsequently fixed.
...
- Docs: `Dreamerv4_paper.pdf`, `docs/archive/DYNAMICS_VS_PAPER.md` (paper-vs-code, line-cited), `docs/archive/DYNAMICS_REVIEW.md`, `docs/archive/DREAMERV4_AUDIT.md`.
