...
- **World-model encoder**: Step 1' recovered checkpoint `dyn179_s1prime_latentonly/dynamics_latest.pt` (tau0.9 ~26; the HUD-loss plateau is fixed — see `docs/archive/WM_DEBUG_LOG_2026-07-14.md`). BC is trained *on this backbone*.
