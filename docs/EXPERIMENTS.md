...
| `server_train/mirror-wave-s0` (4 dirs: crash, resume, resume, resume; a 5th empty dir from a bad resume path was removed) | 09-25 14:45 | C# | mirror, near-wave, 10 Hz, 10 envs | same | running | train CS 3.5 → ~12.5 by 190 episodes; max 27 | running |
